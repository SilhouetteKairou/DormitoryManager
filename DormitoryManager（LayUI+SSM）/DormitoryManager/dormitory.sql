...
/*电费表*/
-- ----------------------------
-- Table structure for `d_electric`
-- ----------------------------
DROP TABLE IF EXISTS `d_electric`;
CREATE TABLE `d_electric` (
  `e_id` int(11) NOT NULL AUTO_INCREMENT,
  `d_id` int(11) NOT NULL,
  `d_dormbuilding` varchar(20) DEFAULT NULL,
  `d_dormelectric` decimal(20,2) DEFAULT NULL,/*用电量*/
  `d_dormbalance` decimal(20,2) DEFAULT NULL,/*余额*/
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`e_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4;
...
-- ----------------------------
-- Records of d_electric
-- ----------------------------
INSERT INTO `d_electric` VALUES ('1', '301', '24号楼', '20' ,'2000000', '2020-04-25 10:51:17', '2020-05-12 17:28:38');
INSERT INTO `d_electric` VALUES ('2', '302', '24号楼', '20' ,'2000000', '2020-05-01 16:36:47', '2020-05-01 16:36:55');
INSERT INTO `d_electric` VALUES ('3', '322', '24号楼', '20' ,'2000000', '2020-05-04 16:37:42', '2020-05-04 16:37:47');
INSERT INTO `d_electric` VALUES ('4', '602', '23号楼', '20' ,'2000000', '2020-05-08 16:38:25', '2020-05-08 16:38:30');
INSERT INTO `d_electric` VALUES ('5', '112', '22号楼', '20' ,'2000000', '2020-05-12 16:38:53', '2020-05-12 16:39:00');
INSERT INTO `d_electric` VALUES ('6', '222', '27号楼', '20' ,'2000000', '2020-05-09 16:39:37', '2020-05-09 16:39:41');
INSERT INTO `d_electric` VALUES ('7', '213', '27号楼', '20' ,'2000000', '2020-05-10 16:40:02', '2020-05-10 16:40:08');


/*桶装水表*/
-- ----------------------------
-- Table structure for `d_barrelwater`
-- ----------------------------
DROP TABLE IF EXISTS `d_barrelwater`;
CREATE TABLE `d_barrelwater` (
  `b_id` int(11) NOT NULL AUTO_INCREMENT,
  `d_id` int(11) NOT NULL,
  `d_dormbuilding` varchar(20) DEFAULT NULL,
  `d_barrelwater_monovalent` int(11) DEFAULT 11,/*桶装水单价，默认为11元*/
  `d_barrelcount` int(11) DEFAULT 1,/*购买桶装水数目，默认为1*/
  `d_amount` int(11) DEFAULT NULL,/*应付金额，等于桶装水单价乘以数目*/
  `d_payment` enum('微信','支付宝','银联','校园卡','现金','QQ支付') NOT NULL,
  `d_distribute` enum('自提','送货上门') NOT NULL,/*配送方式*/
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`b_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4;
...
-- ----------------------------
DELIMITER $$
create trigger auto_calculate_amount before insert on `d_barrelwater`
FOR EACH ROW
begin
  if (new.`d_barrelwater_monovalent` is not null) and (new.`d_barrelcount` is not null) and (new.`d_barrelwater_monovalent`>0) and (new.`d_barrelcount`>0) then
  set new.`d_amount` = (new.`d_barrelwater_monovalent`)*(new.`d_barrelcount`);
  end if;
 end$$
DELIMITER ;

DELIMITER @@
create trigger auto_calculate_amount4 before update on `d_barrelwater`
FOR EACH ROW
begin
 if (new.`d_barrelwater_monovalent` is not null) and (new.`d_barrelcount` is not null) and (new.`d_barrelwater_monovalent`>0) and (new.`d_barrelcount`>0) then
 set new.`d_amount` = (new.`d_barrelwater_monovalent`)*(new.`d_barrelcount`);
 ...
 DELIMITER ;
-- ----------------------------
-- Records of d_barrelwater
-- ----------------------------
INSERT INTO `d_barrelwater`(`b_id`,`d_id`,`d_dormbuilding`,`d_barrelwater_monovalent`,`d_barrelcount`,`d_payment`,`d_distribute`,`create_time`,`update_time`) VALUES ('1', '301', '24号楼', '11' ,'1','微信','自提','2020-04-25 10:51:17', '2020-05-12 17:28:38');
INSERT INTO `d_barrelwater`(`b_id`,`d_id`,`d_dormbuilding`,`d_barrelwater_monovalent`,`d_barrelcount`,`d_payment`,`d_distribute`,`create_time`,`update_time`) VALUES ('2', '302', '24号楼', '11' ,'2','支付宝','送货上门' ,'2020-05-01 16:36:47', '2020-05-01 16:36:55');
INSERT INTO `d_barrelwater`(`b_id`,`d_id`,`d_dormbuilding`,`d_barrelwater_monovalent`,`d_barrelcount`,`d_payment`,`d_distribute`,`create_time`,`update_time`) VALUES ('3', '322', '24号楼', '11' ,'5', '校园卡','送货上门','2020-05-04 16:37:42', '2020-05-04 16:37:47');
INSERT INTO `d_barrelwater`(`b_id`,`d_id`,`d_dormbuilding`,`d_barrelwater_monovalent`,`d_barrelcount`,`d_payment`,`d_distribute`,`create_time`,`update_time`) VALUES ('4', '602', '23号楼', '11' ,'8','现金','送货上门', '2020-05-08 16:38:25', '2020-05-08 16:38:30');
INSERT INTO `d_barrelwater`(`b_id`,`d_id`,`d_dormbuilding`,`d_barrelwater_monovalent`,`d_barrelcount`,`d_payment`,`d_distribute`,`create_time`,`update_time`) VALUES ('5', '112', '22号楼', '11' ,'20','银联','自提', '2020-05-12 16:38:53', '2020-05-12 16:39:00');
INSERT INTO `d_barrelwater`(`b_id`,`d_id`,`d_dormbuilding`,`d_barrelwater_monovalent`,`d_barrelcount`,`d_payment`,`d_distribute`,`create_time`,`update_time`) VALUES ('6', '222', '27号楼', '11' ,'230', 'QQ支付','送货上门','2020-05-09 16:39:37', '2020-05-09 16:39:41');
INSERT INTO `d_barrelwater`(`b_id`,`d_id`,`d_dormbuilding`,`d_barrelwater_monovalent`,`d_barrelcount`,`d_payment`,`d_distribute`,`create_time`,`update_time`) VALUES ('7', '213', '27号楼', '11' ,'99999', '微信','自提','2020-05-10 16:40:02', '2020-05-10 16:40:08');
