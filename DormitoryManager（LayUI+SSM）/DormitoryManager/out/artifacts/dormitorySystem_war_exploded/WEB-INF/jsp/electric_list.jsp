...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="/findElectric">电费缴纳</a>

      </span>
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="/findElectric" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findElectric" >
        ...
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="d_dormbalance" class="layui-input" placeholder="请输入缴纳金额">
                    </div>
                </div>
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${di.list}" var="di">
            <tr>
                ...
                <td>${di.d_dormelectric}</td>
                <td>${di.d_dormbalance}</td>
                ...
                <td>
                    <a title="缴费"    id= "updateEdit"    href="/findElectricById?e_id=${di.e_id}">
                        <i class="layui-icon">&#xe642;</i>
                    </a>
                    <a title="删除" onclick="member_del(this,'${di.e_id}')" href="javascript:;">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
    ...
    <script>
            ...
            form.on('submit(toolbarDemo)', function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // 2. 数组头部新增表头
                        dt.unshift({e_id: 'ID', d_id: '宿舍编号', d_dormbuilding: '宿舍楼', d_dormelectric: '用电量', d_dormbalance: '余额', create_time: '创建日期', update_time: '更新日期'});
        ...
        function member_del(obj,e_id){
            layer.confirm('确认要删除吗？',function(index){
                //发异步删除数据
                $.get("/deleteElectric",{"e_id":e_id},function (data) {
                    if(data =true){
