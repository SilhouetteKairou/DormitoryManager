<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.itheima.po.BarrelWater" %>
...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="/findBarrelWater">桶装水配送</a>

      </span>
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="/findBarrelWater" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findBarrelWater" >
    ...
    <div class="layui-row" id="test" style="display: none;">
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">桶装水数量：</label>
                    <div class="layui-input-block">
                        <input type="text" name="d_barrelcount" class="layui-input" placeholder="请输入桶装水数量">
                    </div>
                </div>
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${di.list}" var="di">
            <tr>
                ...
                <td>${di.d_barrelwater_monovalent}</td>
                <td>${di.d_barrelcount}</td>
                <td>${di.d_amount}</td>
                <td>${di.d_payment}</td>
                <td>${di.d_distribute}</td>
                ...
                <td>
                    <a title="编辑"    id= "updateEdit"    href="/findBarrelWaterById?b_id=${di.b_id}">
                        <i class="layui-icon">&#xe642;</i>
                    </a>
                    <a title="删除" onclick="member_del(this,'${di.b_id}')" href="javascript:;">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
<%--                    <a title="开始用电test" id= "useEdit"    href="/findElectricById?e_id=${di.e_id}">--%>
<%--                        <i class="layui-icon">&#xe642;</i>--%>
<%--                    </a>--%>
<%--                    <a title="开始用电" onclick="" href="javascript:;">--%>
<%--                        <i class="layui-icon">&#xe652;</i>--%>
<%--                    </a>--%>
<%--                    <a title="暂停用电" onclick="" href="javascript:;">--%>
<%--                        <i class="layui-icon">&#xe651;</i>--%>
                    </a>
                </td>
            </tr>
    ...
    <script>
            ...
            form.on('submit(toolbarDemo)', function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // 2. 数组头部新增表头
                        dt.unshift({b_id: 'ID', d_id: '宿舍编号', d_dormbuilding: '宿舍楼', d_barrelwater_monovalent: '桶装水单价', d_barrelcount: '数量',d_amount: '应付金额',d_payment: '支付方式',d_distribute: '配送方式', create_time: '创建日期', update_time: '更新日期'});
                    ...
                    error: function () {
                        //console.log(data);
                        setTimeout(function () {window.location.href='/findBarrelWater';},2000);
                    }
                });
            });
        ...
        function member_del(obj,e_id){
            layer.confirm('确认要删除吗？',function(index){
                //发异步删除数据
                $.get("/deleteBarrelWater",{"e_id":e_id},function (data) {
                    if(data =true){
        ...
        // /*开始用电*/
        // function member_useelec(obj,e_id){
        //     layer.confirm('确认要删除吗？',function(index){
        //         $.get("/useElectric",{"e_id":e_id},function (data) {
        //             if(data =true){
        //                 layer.msg('成功!',{icon:1,time:2000});
        //                 setTimeout(function () {window.location.href='/findElectric';},2000);
        //
        //             }else {
        //                 layer.msg('失败!',{icon:1,time:2000});
        //                 setTimeout(function () {window.location.href='/findElectric';},2000);
        //             }
        //         });
        //     });
