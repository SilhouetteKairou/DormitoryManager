...
<div class="x-body">
    <form class="layui-form"  id="f_auto" action="/updateElectric" method="post" >
        <input type="hidden" value="${sessionScope.d.e_id}" name="e_id" id="e_id"/>
        ...
        <div class="layui-form-item">
            <label for="d_dormbalance" class="layui-form-label">
                <span class="">缴纳金额</span>
            </label>
            <div class="layui-input-inline">
                <input type="text" id="d_dormbalance" name="d_dormbalance"
                       autocomplete="off" value="${sessionScope.d.d_dormbalance}" class="layui-input">
            </div>
        </div>
